...
function Cart() {
  ...
  return (
    <article
      className="bg-white rounded-2xl shadow-2xl p-8 absolute right-8 top-32 left-8 lg:w-96 lg:left-auto lg:right-8 lg:top-20"
      style={{
        zIndex: 1000,
      }}
    >
      ...
      <button className=" w-full text-center bg-orange-500 py-2 px-4 text-white font-bold rounded-lg shadow mt-5  hover:bg-orange-600">
        Checkout
      </button>
    </article>
  );
